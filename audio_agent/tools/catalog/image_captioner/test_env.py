#!/usr/bin/env python3
"""Quick environment test for Image Captioner tool."""
...
def test_imports() -> bool:
    ...
    try:
        ...
        _ = ImageCaptionerModel
        print("  OK ImageCaptionerModel imported successfully")
    except ImportError as exc:
        print(f"  FAIL ImageCaptionerModel: {exc}")
        return False
...
def main() -> int:
    print("=" * 60)
    print("Image Captioner Environment Test")
    print("=" * 60)
    print()
