#!/usr/bin/env python3
"""Quick environment test for Qwen VL OCR tool."""
...
def test_imports() -> bool:
    ...
    try:
        ...
        _ = QwenVLOCRModel
        print("  OK QwenVLOCRModel imported successfully")
    except ImportError as exc:
        print(f"  FAIL QwenVLOCRModel: {exc}")
        return False
...
def main() -> int:
    print("=" * 60)
    print("Qwen VL OCR Environment Test")
    print("=" * 60)
    print()
